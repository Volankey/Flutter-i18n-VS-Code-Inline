...
export class ConfigManager {
  ...
  public async applyConfiguration(config: PluginConfiguration): Promise<void> {
    ...
    await vsConfig.update('diagnostics.missingTranslations', config.diagnostics.missingTranslations);
    await vsConfig.update('diagnostics.partialTranslations', config.diagnostics.partialTranslations);
